...
from Server.ServerFedGMKD import ServerFedGMKD
...
Loaders_test = LocalDataloaders(testset,dict_users_test,args.batch_size,ShuffleorNot = True,frac=args.part*2)
...
if args.alg == 'FedGMKD':    
    server = ServerFedGMKD(args,global_model,Loaders_train,Loaders_test,global_loader_test,logger,device)
